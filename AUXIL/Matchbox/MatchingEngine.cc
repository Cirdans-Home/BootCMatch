...
void MatchingEngine::GabowCardMatching(const Graph& graph,
     std::vector<Size>* mateVec, Size* card) const 
{
  // reset output.
  ResizeVector<Size>(mateVec, 0);
  *card = 0;
  ...
  Size* tmpMateArr = (graph.mNumVtxs == 0) ? NULL : &tmpMateVec[0];
  Size tmpCard = 0;
  rGabowCardMatching<VecItmQue, VecItmStk, LstItmIdxdQue>(graph, tmpMateArr, &tmpCard);
  // set output.
  mateVec->swap(tmpMateVec);
  *card = tmpCard;
}
...
void MatchingEngine::ComputeSpecTwoThirdVtxWght(const Graph& graph,
     std::vector<Size>* mateVec, Size* card, Val* vtxWght) const 
{
  // reset output.
  ResizeVector<Size>(mateVec, 0);
  ...
  *vtxWght=0.0;
  ...
  Size tmpCard = 0;
  Val tmpVtxWght = 0.0;
  rComputeSpecTwoThirdVtxWght<VecItmQue, VecItmStk>(graph, tmpMateArr, &tmpCard, &tmpVtxWght);
  mateVec->swap(tmpMateVec);
  *card = tmpCard;
  *vtxWght=tmpVtxWght;
}

void MatchingEngine::ComputeSpecHalfVtxWght(const Graph& graph,
     std::vector<Size>* mateVec, Size* card, Val* vtxWght) const 
{
  // reset output.
  ResizeVector<Size>(mateVec, 0);
  ...
  *vtxWght=0.0;
  ...
  Size tmpCard = 0;
  Val tmpVtxWght = 0.0;
  rComputeSpecHalfVtxWght<VecItmQue, VecItmStk>(graph, tmpMateArr, &tmpCard, &tmpVtxWght);
  // set output.
  mateVec->swap(tmpMateVec);
  *card = tmpCard;
  *vtxWght=tmpVtxWght;
...
///////
////
void MatchingEngine::ComputeParSpecTwoThirdVtxWght(const Graph& graph,
     std::vector<Size>* mateVec, Size* card, Val* vtxWght) const 
{
  // reset output.
  ResizeVector<Size>(mateVec, 0);
  ...
  *vtxWght=0.0;
  ...
  Size tmpCard = 0;
  Val tmpVtxWght = 0.0;
  rComputeParSpecTwoThirdVtxWght<VecItmQue, VecItmStk>(graph, tmpMateArr, &tmpCard, &tmpVtxWght);
  // set output.
  mateVec->swap(tmpMateVec);
  *card = tmpCard;
  *vtxWght=tmpVtxWght;
...
void MatchingEngine::ComputeParSpecHalfVtxWght(const Graph& graph,
     std::vector<Size>* mateVec, Size* card, Val* vtxWght) const 
{
  // reset output.
  ResizeVector<Size>(mateVec, 0);
  ...
  *vtxWght=0.0;
  ...
  Size tmpCard = 0;
  Val tmpVtxWght = 0.0;
  rComputeParSpecHalfVtxWght<VecItmQue, VecItmStk>(graph, tmpMateArr, &tmpCard, &tmpVtxWght);
  // set output.
  mateVec->swap(tmpMateVec);
  *card = tmpCard;
  *vtxWght=tmpVtxWght;
...
/////////////////
void MatchingEngine::RandomTwoThirdMinusEpsilonEdgWght(const Graph& graph, std::vector<Size>* mateVec, Size* card, Val* edgWght,Size iterations) const 
{
  // reset output.
  ResizeVector<Size>(mateVec, 0);
  *card = 0;
  *edgWght=0.0;
  ...
  Size tmpCard = 0;
  Val tmpEdgWght = 0.0;
  rRandomTwoThirdMinusEpsilonEdgWght<VecItmQue>(graph, tmpMateArr, &tmpCard, &tmpEdgWght, iterations);
  // set output.
  mateVec->swap(tmpMateVec);
  *card = tmpCard;
  *edgWght=tmpEdgWght;
...
///////
void MatchingEngine::RandomOrderTwoThirdMinusEpsilonEdgWght(const Graph& graph, std::vector<Size>* mateVec, Size* card, Val* edgWght,Size phases) const 
{
  // reset output.
  ResizeVector<Size>(mateVec, 0);
  *card = 0;
  *edgWght=0.0;
  ...
  Size tmpCard = 0;
  Val tmpEdgWght = 0.0;
  rRandomOrderTwoThirdMinusEpsilonEdgWght<VecItmQue>(graph, tmpMateArr, &tmpCard, &tmpEdgWght, phases);
   // set output.
  mateVec->swap(tmpMateVec);
  *card = tmpCard;
  *edgWght=tmpEdgWght;
...
///////////
void MatchingEngine::GPAEdgWght(const Graph& graph, std::vector<Size>* mateVec, Size* card, Val* edgWght) const 
{
  // reset output.
  ResizeVector<Size>(mateVec, 0);
  *card = 0;
  *edgWght=0.0;
  ...
  Val tmpEdgWght = 0.0;
  vector<Val> wVec;
  ResizeVector<Val>(&wVec, graph.mNumVtxs);
  Val* wArr = (graph.mNumVtxs == 0) ? NULL : &wVec[0];
  rGreedyVariant<VecItmQue>(graph, tmpMateArr, wArr, &tmpCard, &tmpEdgWght);
   // set output.
  mateVec->swap(tmpMateVec);
  *card = tmpCard;
  *edgWght=tmpEdgWght;
...
void MatchingEngine::nComponents(const Graph& graph) const
{
	rnComponents<VecItmQue>(graph);
}
